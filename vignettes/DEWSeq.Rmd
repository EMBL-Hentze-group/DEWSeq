...
```{r, fig.cap = "Crosslink site trunction at reverse transcription", fig.small=TRUE, echo = FALSE}
# out.width="80%",
...
```{r , fig.cap = "Sliding window approach with single-nucleotide position count data", out.width="140%", out.height="120%", echo = FALSE} 
