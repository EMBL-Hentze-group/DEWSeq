...
```{r digestionpattern image, fig.cap = "Different RNase concentrations will result in different fragment sizes.", echo = FALSE} 
...
different likelihood of truncating or reading through. As mentioned before 
this might be a different for different proteins.   
