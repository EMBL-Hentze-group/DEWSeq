...
```{r readthrough image, fig.cap = "Read-through and early truncations", echo = FALSE} 
...
crosslink sites from different proteins. Again, although low crosslinking
efficency should make this less likely.
