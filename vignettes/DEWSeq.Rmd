...
Wolfgang Huber for mentoring, advice and discussion. Benjamin Lang and Gian Tartaglia for great help with functional analysis and benchmarking. Mike Love, Simon Anders, Bernd Klaus and Frederick Ziebell for comments and discussion.
...
```{r, fig.cap = "Crosslink site trunction at reverse transcription", fig.width=200,echo =F}
...
Additionally, UV crosslinking has differe
...
Antibodies 
CLIP samples have a lot of background. 

#### RNAase concentrations and protein protection

In the iCLIP and eCLIP protocols...

### Method

#### Sliding window testing 

We use a one-sided wald test from `r Biocpkg("DESeq2")` testing for enrichment.
...
in contrary to large fragments detected in ChIP-seq, 
...
Replicates and input controls are required for DEWSeq
...
# Binding sites detection with DEWSeq
