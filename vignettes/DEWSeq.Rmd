...
```{r, fig.cap = "Truncation sites (referred to as crosslink sites) are the neighboring position of the aligned read", out.width="100%", echo = FALSE} 
...
```{r, fig.cap = "Different RNase concentrations will result in different fragment sizes.", out.width="100%", echo = FALSE} 
...
```{r, fig.cap = "Read-throughs", out.width="100%", echo = FALSE} 
...
```{r , fig.cap = "Sliding window approach with single-nucleotide position count data", out.width="100%", echo = FALSE} 
...
```{r, fig.cap = "Combining significant windows", echo = FALSE, out.width="100%"} 
# fig.width=200, out.width="200px"
...
```{r, fig.cap = "Combining significant windows", out.width="100%", echo = FALSE} 
