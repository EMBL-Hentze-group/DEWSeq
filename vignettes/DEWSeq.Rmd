...
iCLIP (individual nucleotide resolution crosslinking 
and immunoprecipitation) [@Konig2010] and the derived 
eCLIP (enhanced CLIP) [@VanNostrand2016] sequencing protocols
...
![Crosslink site trunction at reverse transcription](truncation.png)
...
Typically, CLIP-seq samples do have a lot of background which consists 
of a mix of various transcripts with different expression levels. 
...
### Count data and annotation

The preprocessing is done in two sections
...
RNA-binding proteins have different binding modes to ... #TODO
